...
def send_HV_quantities(ppc_master_obj):
    ...
    message1 = { "destination": "localPlatform", "value_name": "active_power_ppc", "value": str(var1) }
    var2 = ppc_master_obj.q_actual_hv*ppc_master_obj.S_nom
    message2 = { "destination": "localPlatform", "value_name": "reactive_power_ppc", "value": str(var2) }
    message3 = { "destination": "localPlatform", "value_name": "frequency_ppc", "value": str(ppc_master_obj.f_actual) }
    ...
    message4 = { "destination": "localPlatform", "value_name": "current_ppc", "value": str(I) }
    V = ppc_master_obj.v_actual*150
    message5 = { "destination": "localPlatform", "value_name": "voltage_ppc", "value": str(V) }
    if ppc_master_obj.p_actual_hv == 0: PF = 1
    else: PF = math.cos(math.atan(ppc_master_obj.q_actual_hv/ppc_master_obj.p_actual_hv))
    message6 = { "destination": "localPlatform", "value_name": "power_factor_ppc", "value": str(PF) }
    try:
        ppc_master_obj.socket_tx.send_json(message1, zmq.NOBLOCK)
        ppc_master_obj.socket_tx.send_json(message2, zmq.NOBLOCK)
...
def send_max_capability(ppc_master_obj):
    ...
    message1 = { "destination": "localPlatform", "value_name": "power_factor_ppc", "value": str(var1) }
    ...
    message2 = {"destination": "localPlatform", "value_name": "max_active_capability", "value": str(var2)}
...
#     message1 = { "destination": "localPlatform", "value_name": "temperature", "value": str(round(ppc_master_obj.temp, 2)) }
    message1 = { "destination": "localPlatform", "value_name": "max_reactive_capability", "value": str(round(ppc_master_obj.temp, 2)) }
